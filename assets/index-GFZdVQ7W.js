...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function eu(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vc(),fragmentShader:`
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function tu(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vc(),fragmentShader:`
...
`+Kb(s.getShaderSource(e),a)}else return i}function Jb(s,e){const t=Qb(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Zb(s,e){let t;switch(e){case Jp:t="Linear";break;case Zp:t="Reinhard";break;case $p:t="Cineon";break;case Ua:t="ACESFilmic";break;case wl:t="AgX";break;case Rl:t="Neutral";break;case em:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ea=new D;function $b(){je.getLuminanceCoefficients(Ea);const s=Ea.x.toFixed(4),e=Ea.y.toFixed(4),t=Ea.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ar).join(`
`)),a=oc(a),a=uu(a,t),a=du(a,t),o=oc(o),o=uu(o,t),o=du(o,t),a=fu(a),o=fu(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
